...
parent_subsystem: OSS-MA-COM-INT-002
---

# M&A Integration Architecture — Sequence Altitude — Integration Domain — Target State
...
descending from Component pattern `OSS-MA-COM-INT-002`. It does not restate Component inventory;
