...
parent_subsystem: OSS-MA-COM-HCM-001
---

# M&A Integration Architecture — Sequence Altitude — Human Capital Domain — Current State

## Altitude and Parentage

This pattern sits at **Sequence** altitude under the M&A Integration Architecture domain.
It sequences governed interaction order, control points, and handoffs for **Human Capital Domain**,
descending from Component pattern `OSS-MA-COM-HCM-001`. It does not restate Component inventory;
it orders how those components collaborate through time.

**Sequence focus:** hire-to-retire process order, payroll cycles, and benefits enrollment events.
