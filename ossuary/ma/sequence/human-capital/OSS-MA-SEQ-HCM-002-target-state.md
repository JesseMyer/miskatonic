...
parent_subsystem: OSS-MA-COM-HCM-002
---

# M&A Integration Architecture — Sequence Altitude — Human Capital Domain — Target State
...
descending from Component pattern `OSS-MA-COM-HCM-002`. It does not restate Component inventory;
