...
parent_subsystem: OSS-MA-SEQ-INT-001
---

# M&A Integration Architecture — Schema Altitude — Integration Domain — Current State
...
descending from Sequence pattern `OSS-MA-SEQ-INT-001`. It names what must be true in data for the
