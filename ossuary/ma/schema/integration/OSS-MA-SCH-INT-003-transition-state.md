...
parent_subsystem: OSS-MA-SEQ-INT-003
---

# M&A Integration Architecture — Schema Altitude — Integration Domain — Transition State

## Altitude and Parentage

This pattern sits at **Schema** altitude under the M&A Integration Architecture domain.
It declares the governed data shapes, keys, lineage, and authority for **Integration Domain**,
descending from Sequence pattern `OSS-MA-SEQ-INT-003`. It names what must be true in data for the
declared sequences and components to be coherent.

**Schema focus:** integration payloads, canonical message schemas, identity correlation keys, and lineage across interfaces.
