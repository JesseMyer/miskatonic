...
parent_subsystem: OSS-MA-SEQ-INT-002
---

# M&A Integration Architecture — Schema Altitude — Integration Domain — Target State
...
descending from Sequence pattern `OSS-MA-SEQ-INT-002`. It names what must be true in data for the
