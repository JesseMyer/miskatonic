...
parent_subsystem: OSS-MA-SEQ-HCM-003
---

# M&A Integration Architecture — Schema Altitude — Human Capital Domain — Transition State
...
descending from Sequence pattern `OSS-MA-SEQ-HCM-003`. It names what must be true in data for the
