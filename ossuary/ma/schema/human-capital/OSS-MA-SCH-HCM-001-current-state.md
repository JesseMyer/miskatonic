...
parent_subsystem: OSS-MA-SEQ-HCM-001
---

# M&A Integration Architecture — Schema Altitude — Human Capital Domain — Current State
...
descending from Sequence pattern `OSS-MA-SEQ-HCM-001`. It names what must be true in data for the
