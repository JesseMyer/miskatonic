...
parent_subsystem: OSS-MA-SEQ-FIN-001
---

# M&A Integration Architecture — Schema Altitude — Finance Domain — Current State
...
descending from Sequence pattern `OSS-MA-SEQ-FIN-001`. It names what must be true in data for the
