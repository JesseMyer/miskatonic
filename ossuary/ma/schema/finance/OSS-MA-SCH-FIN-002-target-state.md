...
parent_subsystem: OSS-MA-SEQ-FIN-002
---

# M&A Integration Architecture — Schema Altitude — Finance Domain — Target State
...
descending from Sequence pattern `OSS-MA-SEQ-FIN-002`. It names what must be true in data for the
