...
parent_subsystem: OSS-MA-SEQ-CUS-001
---

# M&A Integration Architecture — Schema Altitude — Customer Domain — Current State
...
descending from Sequence pattern `OSS-MA-SEQ-CUS-001`. It names what must be true in data for the
