...
parent_subsystem: OSS-MA-SEQ-CUS-002
---

# M&A Integration Architecture — Schema Altitude — Customer Domain — Target State
...
descending from Sequence pattern `OSS-MA-SEQ-CUS-002`. It names what must be true in data for the
