...
# Vril Prompt — VRL-MA-SCH-002 — Schema — diagram

## Purpose

Invoke Vril to produce a **diagram** deliverable for M&A Integration Architecture work at
**Schema** altitude. The output must be traceable to declared Ossuary patterns and must
...
- Relevant Ossuary pattern IDs at Schema altitude (name them explicitly)
