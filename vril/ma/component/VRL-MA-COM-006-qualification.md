...
# Vril Prompt — VRL-MA-COM-006 — Component — qualification

## Purpose

Invoke Vril to produce a **qualification** deliverable for M&A Integration Architecture work at
...
Produce a qualification prompt: single construct candidate, single decisive question, possible resolutions with typing implications, and which Ossuary fields are held.
