...
# Vril Prompt — VRL-MA-SUB-005 — Subsystem — finding

## Purpose

Invoke Vril to produce a **finding** deliverable for M&A Integration Architecture work at
...
Produce a Bureau-style finding: severity, broken construct relationship, evidence, suggested remediation tier (Ossuary reference tier), and whether the finding blocks descent.
