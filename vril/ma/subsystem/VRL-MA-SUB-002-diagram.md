...
# Vril Prompt — VRL-MA-SUB-002 — Subsystem — diagram

## Purpose

Invoke Vril to produce a **diagram** deliverable for M&A Integration Architecture work at
**Subsystem** altitude. The output must be traceable to declared Ossuary patterns and must
...
- Relevant Ossuary pattern IDs at Subsystem altitude (name them explicitly)
